...
public class PlayerScript : MonoBehaviour
{
    ...
    private newHairController haircontroll;
    ...
    void Start()
    {
        foreach (GameObject item in actors)
        {
            ...
            if (item.activeInHierarchy)
            {
                ...
                playerAnim = item.GetComponent<Animator>();
                playerAnim.avatar = playerAnim.avatar;
                haircontroll= item.GetComponent<newHairController>();
                charplayer = item;
            }
        }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if(other.tag=="final")
        {
            ...
            canvasManager.Instance.coinsNo = roundNo * 50;
            PlayerPrefs.SetInt("coins", canvasManager.Instance.coinsNo);
            //if (isJumped)
            //{
            //    end = true;
            //    rb.isKinematic = true;
