...
public class aiScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        int ran1 = Random.Range(0, AIList.Length);


        AIList[ran1].gameObject.SetActive(true);


        playerAnim = AIList[ran1].gameObject.GetComponent<Animator>();
    ...
    void Start()
    {
        ...
        {
            pointsParent = GameObject.Find("AI_1").transform;

        }else   if (transform.name == "Ai_2")
        {
            pointsParent = GameObject.Find("AI_2").transform;

        }
        else if (transform.name == "Ai_1")
        {
            pointsParent = GameObject.Find("AI_3").transform;
